...
router.post('/add', async (req, res) => {
    const { name, fechaentrega, descripcion, talle, espalda, cintura, base, largoblusa, largopantalon, falda, largototal, cinturafalda, cinturapantalon, alturabusto, separacionbusto, escote, manga } = req.body;
    const newClient = {
        name,
        telefono,
        busto,
